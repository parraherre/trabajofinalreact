...
export function Colaboraciones() {
    let colaboraciones = [
        {
            ...
            foto: "https://firebasestorage.googleapis.com/v0/b/musicasph-be862.appspot.com/o/colaboracion1.jpg?alt=media&token=8657b219-52af-44f3-961c-e94870c79cb5",
            dato: "Hay canciones que nacen para brillar y “Wake Me Up” es una de ellas. Esta canción estrenada en 2013 se volvió un himno que no podía faltar en ninguna fiesta. A la fecha continúa vigente, con sus beats que aceleran el corazón invita a bailar y olvidar los problemas. Para esta canción Avicii colaboró con el cantante Aloe Blacc y el guitarrista de Incubus, Mike Einziger. Cada vez que suena es imposible no cantar con sentimiento: “So wake me up when it’s all over, when I’m wiser and I’m older…”.",
            id: "1"
        },
        {
            nombre: "Hey brother",
            foto: "https://firebasestorage.googleapis.com/v0/b/musicasph-be862.appspot.com/o/colaboracion2.jpg?alt=media&token=2b4b781e-8e8b-422f-8e25-99be94c40e18",
            dato: "Esta canción también se estrenó en 2013 y contó con la increíble voz de Dan Tyminski, un cantante de bluegrass que le aportó el toque perfecto. Así crearon una mezcla de dance y country que sorprendió gratamente. “Hey Brother” se convirtió en otro clásico del DJ.",
            id: "2"
        },
        {
            nombre: "“Lonely Together” ft. Rita Ora",
            foto: "https://firebasestorage.googleapis.com/v0/b/musicasph-be862.appspot.com/o/colaboracion3.jpg?alt=media&token=a3ebcedc-9200-4046-a9dc-f21496feaa50",
            dato: "Esta canción que el DJ sueco lanzó apenas el año pasado cuenta con la colaboración de Rita Ora. Con la experiencia que Avicii logró adquirir con el tiempo, en este track el DJ se lució y creó una increíble canción con un toque emotivo. Esta pieza fue el segundo sencillo del EP Avīci (01).",
            id: "3"
        },
        {
            nombre: "My feelings for You",
            foto: "https://firebasestorage.googleapis.com/v0/b/musicasph-be862.appspot.com/o/colaboracion4.jpg?alt=media&token=b0db56b9-d401-48ef-9de4-b0ac32bc040a",
            dato: "Esta increíble canción del 2010, contó con el talento de Sebastien Drums. La combinación resultó en un track con una onda muy disco que invita a vestirse de lentejuelas y sacudir el cuerpo. Esta canción, que es un remix de un tema de Cassius, se convirtió en uno de los grandes favoritos de los fans.",
            id: "4"
        },
        {
            nombre: "Without you",
    ...
    return (
        ...
        <>
            ...
            <div className="row row-cols-1 row-cols-md-4 g-3 w-100">

                {
                    colaboraciones.map(function (colaboracion) {
                        return (
                            <div key={colaboracion.id}>
                                <div className="col">
